class CountdownTimer {
    ...
    createTimerHTML() {
        ...
        <div class="field">
          <span class="value" data-value="days-${this.selector}">0</span>
          <span class="label">Days</span>
        </div>
      
        <div class="field">
          <span class="value" data-value="hours-${this.selector}">00</span>
          <span class="label">Hours</span>
        </div>
      
        <div class="field">
          <span class="value" data-value="mins-${this.selector}">00</span>
          <span class="label">Minutes</span>
        </div>
      
        <div class="field">
          <span class="value" data-value="secs-${this.selector}">00</span>
